    ...
    <div className="home-container">
      ...
      <div className="home-banner">
        <div className="home-banner1 bannerContainer">
          <h1 className="home-banner-heading heading2">
            Comprehensive Information Security &amp; Data Protection Consulting
          </h1>
            ...
            <span>
              <span>
                <span>
                  ...
                  digital assets. With our team of experienced professionals, we
                  provide expert guidance and solutions tailored to your
                  specific needs.
                </span>
                <span>
                  <span
      ...
      <div className="home-footer">
        <footer className="home-footer1 footerContainer">
          ...
          <img alt="image" src="/threat%20.-200h.png" className="home-image1" />
        </footer>
      </div>
    </div>
  )
